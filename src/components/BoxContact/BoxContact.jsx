  ...
  return (
    <>
        {/* <Tooltip label='Detail' placement='bottom-start' borderRadius="12px" bg='blue.500' fontSize="lg"> */}
            <Box className="box_contact" style={{ display: "flex", width: "85%", height: "6rem", justifyContent: "Space-between", alignItems:"center", gap: "1rem", padding: "10px 20px", borderRadius: "12px", backgroundColor: "white", border: "2px solid rgb(240, 243, 247)", cursor:"pointer", boxShadow:"rgba(0, 0, 0, 0.15) 1.95px 1.95px 2.6px"}}>
                ...
                <Box style={{ display:"flex", width:"auto", gap:"20px"}}>
                    <Tooltip label='Edit' placement='bottom' borderRadius="12px" bg='orange.500' zIndex={1}>
                        <Button colorScheme='orange' style={{ display:"flex", width:"3rem", height:"3rem", borderRadius:"50%"}} onClick={props.onEdit}>
                            <FaEdit style={{ color:"white" }} />
                        </Button>
                    </Tooltip>
                    <Tooltip label='Delete' placement='bottom' borderRadius="12px" bg='red.500' zIndex={1}>
                        <Button colorScheme='red' style={{ display:"flex", width:"3rem", height:"3rem", borderRadius:"50%"}} onClick={props.onDelete}>

  ...
  return (
    <>
      <Modal isOpen={props.isOpen} size={"xl"} onClose={props.onClose}>
        <ModalOverlay />
        <ModalContent>
          <ModalHeader fontSize={"24px"}>Verify Delete</ModalHeader>
          <ModalCloseButton height={"40px"} width={"40px"} borderRadius={"100px"}/>
          <ModalBody>
            <p style={{fontSize:"18px"}}>Are you sure Delete Contact <span style={{fontWeight:"bold"}}>{props.namaProduk}</span>?</p>
          </ModalBody>
